...
EOF;
    ...
    function hpro_get_wiki_by_curl($curl_params){
...
curl_setopt_array($curl, array(
 ...
 $response = curl_exec($curl);  if(empty($response)){echo 'I have nothing'; exit();}
 $err = curl_error($curl);
...
if ($err) {
 ...
 return $response_array;  
    ...
    function hpro_set_curl_url($key_list, $value_list, $curl_url, $num_param, $method){
