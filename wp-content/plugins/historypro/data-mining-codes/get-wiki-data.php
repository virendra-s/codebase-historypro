...
$_GET['wiki_monthnum'] = 8;
$_GET['wiki_datenum'] = 15;
$_GET['wiki_monthname'] = 'august';
...
$curl_params = hpro_create_curl_params($key, $value, $url , $num_param, $method);

//Curl wiki and get response
$response = hpro_get_remote_data_by_curl($curl_params);
