            ...
            <tr class="gateway gateway_custommix" <?php if ($gateway != "custommix") { ?>style="display: none;"<?php } ?>>
             ...
             <tr class="gateway gateway_custommix" <?php if ($gateway != "custommix") { ?>style="display: none;"<?php } ?>>
                ...
                <td>
                    ...
                    <br/>
                    <small><?php _e('Service Id give by Fortumo'); ?></small>
                </td>
            </tr>
            <tr class="gateway gateway_custommix" <?php if ($gateway != "custommix") { ?>style="display: none;"<?php } ?>>
                <th scope="row" valign="top">
                ...
                <td>
                    ...
                    <br/>
                    <small><?php _e('Secret give by Fortumo'); ?></small>
                </td>
            </tr>
                <tr class="gateway gateway_custommix" <?php if ($gateway != "custommix") { ?>style="display: none;"<?php } ?>>
                <th scope="row" valign="top">
                ...
                <td>
                    ...
                    <br/>
                    <small><?php _e('Write TEST for test mode and LIVE for live mode.'); ?></small>
                </td>
            </tr>
...
//Send user to fortumo
        public function pmpro_checkout_order_fortumo(&$order) //sendTocustommix(&$order)
        {
          ...
          //taxes on initial amount
            ...
            //Create parameters array to send to checksum
						...
						<center><h1>You are being redirected to Fortumo payment dashboard.</br>Please do not refresh this page...</h1></center>
							...
							<table border="1">
								<tbody>
									...
									<input type="hidden" name="operation_referance" value="$order_id">
									<input type="hidden" name="credit_name" value="$credit_name">
									<input type="hidden" name="price" value="$custommix_amount">
									<input type="hidden" name="currency" value="$custommix_industry_type_id">									
									<input type="hidden" name="TXN_AMOUNT" value="INR">
									<input type="hidden" name="callback_url" value="https://www.wt-local-may.dev">
