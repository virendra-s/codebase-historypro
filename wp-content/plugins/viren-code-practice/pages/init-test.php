...
function wtvs_test_init(){
	...
	
	{
		...
		extract(
			...
			echo 'This is in test_init'.$order_id; exit();
...
add_filter( 'the_content', 'wtvs_test_process_payment_status_content' );

function wtvs_test_process_payment_status_content($content)
{
	$status = 'Hi';
