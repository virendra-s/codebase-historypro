...
*/
function wtvs_pmpro_shortcode_account($atts, $content=null, $code="")
{
				...
				<?php 
					...
					{ 
						...
						$invoice->getMembershipLevel();
                                                if($invoice->status == 'success' || $invoice->status == 'Success'){$invoice->status = 'Paid';}else{$invoice->status = 'Pending';}
						?>
						<tr id="pmpro_account-invoice-<?php echo $invoice->code; ?>">
							...
							<td><a href="<?php echo pmpro_url("invoice", "?invoice=" . $invoice->code)?>"><?php echo $invoice->code;?></td>
                                                        <td><a href="<?php echo pmpro_url("invoice", "?invoice=" . $invoice->code)?>"><?php echo $invoice->status;?></td>
...
add_shortcode('wtvs_pmpro_account', 'wtvs_pmpro_shortcode_account');
